...
public enum TablerIconToken: String {
    ...
    case discount2 = "discount-2" // Alias of rosette-discount
    case discount2Off = "discount-2-off" // Alias of rosette-discount-off
    case discountCheck = "discount-check" // Alias of rosette-discount-check
    case handRock = "hand-rock" // Alias of hand-love-you
    case sortDeacendingSmallBig = "sort-deacending-small-big" // Alias of sort-descending-small-big
    case shiJumping = "shi-jumping" // Alias of ski-jumping
    case boxSeam = "box-seam" // Alias of package
    case kering // Alias of kerning
    case twoFa // Alias of auth-2fa
    case threeDCubeSphere = "threeD-cube-sphere" // Alias of cube-3d-sphere
    case threeDCubeSphereOff = "threeD-cube-sphere-off" // Alias of cube-3d-sphere-off
    case threeDRotate = "threeD-rotate" // Alias of rotate-3d
    case twelveHours = "twelve-hours" // Alias of hours-12
    case twentyFourHours = "twentyFour-hours" // Alias of hours-24
    case threeSixtyView = "threeSixty-view" // Alias of view-360-number
    case circle0 = "circle-0" // Alias of circle-number-0
    case circle1 = "circle-1" // Alias of circle-number-1
    case circle2 = "circle-2" // Alias of circle-number-2
    case circle3 = "circle-3" // Alias of circle-number-3
    case circle4 = "circle-4" // Alias of circle-number-4
    case circle5 = "circle-5" // Alias of circle-number-5
    case circle6 = "circle-6" // Alias of circle-number-6
    case circle7 = "circle-7" // Alias of circle-number-7
    case circle8 = "circle-8" // Alias of circle-number-8
    case circle9 = "circle-9" // Alias of circle-number-9
    case hexagon0 = "hexagon-0" // Alias of hexagon-number-0
    case hexagon1 = "hexagon-1" // Alias of hexagon-number-1
    case hexagon2 = "hexagon-2" // Alias of hexagon-number-2
    case hexagon3 = "hexagon-3" // Alias of hexagon-number-3
    case hexagon4 = "hexagon-4" // Alias of hexagon-number-4
    case hexagon5 = "hexagon-5" // Alias of hexagon-number-5
    case hexagon6 = "hexagon-6" // Alias of hexagon-number-6
    case hexagon7 = "hexagon-7" // Alias of hexagon-number-7
    case hexagon8 = "hexagon-8" // Alias of hexagon-number-8
    case hexagon9 = "hexagon-9" // Alias of hexagon-number-9
    case square0 = "square-0" // Alias of square-number-0
    case square1 = "square-1" // Alias of square-number-1
    case square2 = "square-2" // Alias of square-number-2
    case square3 = "square-3" // Alias of square-number-3
    case square4 = "square-4" // Alias of square-number-4
    case square5 = "square-5" // Alias of square-number-5
    case square6 = "square-6" // Alias of square-number-6
    ...
    public static let iconTokenMap = [
        ...
        // "square-letter-y-filled": "\u{fdef}", Unsupported Unicode
        "square-letter-z": "\u{f493}",
        // "square-letter-z-filled": "\u{fdee}", Unsupported Unicode
        "square-minus": "\u{eb29}",
        ...
        // "square-rounded-letter-a-filled": "\u{fded}", Unsupported Unicode
        "square-rounded-letter-b": "\u{f5af}",
        // "square-rounded-letter-b-filled": "\u{fdec}", Unsupported Unicode
        "square-rounded-letter-c": "\u{f5b0}",
        // "square-rounded-letter-c-filled": "\u{fdeb}", Unsupported Unicode
        "square-rounded-letter-d": "\u{f5b1}",
        // "square-rounded-letter-d-filled": "\u{fdea}", Unsupported Unicode
        "square-rounded-letter-e": "\u{f5b2}",
        // "square-rounded-letter-e-filled": "\u{fde9}", Unsupported Unicode
        "square-rounded-letter-f": "\u{f5b3}",
        // "square-rounded-letter-f-filled": "\u{fde8}", Unsupported Unicode
        "square-rounded-letter-g": "\u{f5b4}",
        // "square-rounded-letter-g-filled": "\u{fde7}", Unsupported Unicode
        "square-rounded-letter-h": "\u{f5b5}",
        // "square-rounded-letter-h-filled": "\u{fde6}", Unsupported Unicode
        "square-rounded-letter-i": "\u{f5b6}",
        // "square-rounded-letter-i-filled": "\u{fde5}", Unsupported Unicode
        "square-rounded-letter-j": "\u{f5b7}",
        // "square-rounded-letter-j-filled": "\u{fde4}", Unsupported Unicode
        "square-rounded-letter-k": "\u{f5b8}",
        // "square-rounded-letter-k-filled": "\u{fde3}", Unsupported Unicode
        "square-rounded-letter-l": "\u{f5b9}",
        // "square-rounded-letter-l-filled": "\u{fde2}", Unsupported Unicode
        "square-rounded-letter-m": "\u{f5ba}",
        // "square-rounded-letter-m-filled": "\u{fde1}", Unsupported Unicode
        "square-rounded-letter-n": "\u{f5bb}",
        // "square-rounded-letter-n-filled": "\u{fde0}", Unsupported Unicode
        "square-rounded-letter-o": "\u{f5bc}",
        // "square-rounded-letter-o-filled": "\u{fddf}", Unsupported Unicode
        "square-rounded-letter-p": "\u{f5bd}",
        // "square-rounded-letter-p-filled": "\u{fdde}", Unsupported Unicode
        "square-rounded-letter-q": "\u{f5be}",
        // "square-rounded-letter-q-filled": "\u{fddd}", Unsupported Unicode
        "square-rounded-letter-r": "\u{f5bf}",
        // "square-rounded-letter-r-filled": "\u{fddc}", Unsupported Unicode
        "square-rounded-letter-s": "\u{f5c0}",
        // "square-rounded-letter-s-filled": "\u{fddb}", Unsupported Unicode
        "square-rounded-letter-t": "\u{f5c1}",
        // "square-rounded-letter-t-filled": "\u{fdda}", Unsupported Unicode
        "square-rounded-letter-u": "\u{f5c2}",
        // "square-rounded-letter-u-filled": "\u{fdd9}", Unsupported Unicode
        "square-rounded-letter-v": "\u{f5c3}",
        // "square-rounded-letter-v-filled": "\u{fdd8}", Unsupported Unicode
        "square-rounded-letter-w": "\u{f5c4}",
        // "square-rounded-letter-w-filled": "\u{fdd7}", Unsupported Unicode
        "square-rounded-letter-x": "\u{f5c5}",
        // "square-rounded-letter-x-filled": "\u{fdd6}", Unsupported Unicode
        "square-rounded-letter-y": "\u{f5c6}",
        // "square-rounded-letter-y-filled": "\u{fdd5}", Unsupported Unicode
        "square-rounded-letter-z": "\u{f5c7}",
        // "square-rounded-letter-z-filled": "\u{fdd4}", Unsupported Unicode
        ...
        "stack": "\u{eb2d}",
        "stack-2": "\u{eef7}",
        // "stack-2-filled": "\u{fdd3}", Unsupported Unicode
        "stack-3": "\u{ef9d}",
        // "stack-3-filled": "\u{fdd2}", Unsupported Unicode
        "stack-back": "\u{fd26}",
        "stack-backward": "\u{fd27}",
        // "stack-filled": "\u{fdd1}", Unsupported Unicode
        ...
        // "transition-bottom-filled": "\u{fdd0}", Unsupported Unicode
        ...
        "kering": "\u{efb8}",
        "twoFa": "\u{eca0}",
        "threeD-cube-sphere": "\u{ecd7}",
        "threeD-cube-sphere-off": "\u{f3b5}",
        "threeD-rotate": "\u{f020}",
        "twelve-hours": "\u{fc53}",
        "twentyFour-hours": "\u{f5e7}",
        "threeSixty-view": "\u{f566}",
        "circle-0": "\u{ee34}",
        "circle-1": "\u{ee35}",
        "circle-2": "\u{ee36}",
        "circle-3": "\u{ee37}",
